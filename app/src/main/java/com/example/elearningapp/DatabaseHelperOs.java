...
public class DatabaseHelperOs extends SQLiteOpenHelper {


    static final String DATANAME="QuizOs.DB";
    static final int VERSION=1;

    static final String DATABSETABLE="OsScore";
    static final String USER_ID="_ID";
    static final String USER_NAME="user_name";
    static final String USER_PASSWORD="password";

    private static final String CREATE="CREATE TABLE OsScore( ID INTEGER PRIMARY KEY AUTOINCREMENT ,Correct INTEGER NOT NULL, Wrong INTEGER NOT NULL);";

    public DatabaseHelperOs(@Nullable Context context) {
